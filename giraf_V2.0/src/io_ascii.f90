...
!-----------------------------------------------------------------------------      
      ...
      !Lit les donnees sans remplacer x et y
      do j=1,ny
        do i=1, nx
	  read(10,*,end=99) x_,y_,valeur(:,i,j)
	  !if (x_.ne.x(i,j))write(*,*)'warning: x different',x,x_
	  !if (y_.ne.y(i,j))write(*,*)'warning: y different',y,y_
	end do
      end do
