...
!--------------------------------------------------------------------
	  ...
	  rsearch = distGrid_dg * 5
	  
          do i0=1,nx0
            do j0=1,ny0
	      rtemp = ((lon_g0(i0,j0)-lon_g2(i2,j2))**2+(lat_g0(i0,j0)-lat_g2(i2,j2))**2)**.5
...
!--------------------------------------------------------------------
      ...
      call wcal2d(nx0,ny0,ix1,iy1,wx1,wy1,lon_g0,lat_g0,nx2,ny2,lon_g2,lat_g2)
