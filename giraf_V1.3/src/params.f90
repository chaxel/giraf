      ...
      integer, parameter    :: nvar_emis  = 5     ! utilise 3 polluants NOX, PPM_fin, PPM_coa       
      character(len=fnstrl) :: var_emis_name(nvar_emis)  = (/'NOX','PM10','PM25','PPM_fin','PPM_coa'/)  ! ne pas modifier  
      ...
      real, parameter       :: tbl_ratio_emi_snap(nsnap1) = (/ 0.00, 1.00, 0.00, 0.00, 0.00, 1.00, 1.00, 1.00, 1.00, 1.00, 0.00 /)                 
      ...
      integer :: emis_inox
      integer :: emis_ipm10
      integer :: emis_ippm_coa,emis_ippm_fin   
