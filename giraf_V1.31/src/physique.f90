...
!---------------------------------------------------------------------------------------------------------------------     
      ...
      if (ismooth)     call smoothing2d(nx1,ny1,topo_g2,topo_g1,smooth_ratio)
...
!---------------------------------------------------------------------------------------------------------------------            
	...
	do j2=1,ny2	  
	  if (val_g1_var(met_iwins,i2,j2,1).ge.w10m_limit(1)) then	  
	    !méthode au 06/10/2010: le facteur d'attenuation se calcule 
	    !à partir du ratio vent raffiné/vent brut
